...
console.log('OR using forEach only');
...
employee.filter(emp=>emp[4]>30000).forEach(element=>console.log(element[1]))
...
console.log('----------------------------------');
//print the employee name who have lowest salary
console.log('employee name who have lowest salary');
