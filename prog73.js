...
products.filter(item=>item[3]==0).forEach(pro=>console.log(pro[1]))
...
hstock=products.reduce((pro1,pro2)=>pro1[3]>pro2[3]?pro1:pro2)
console.log(hstock[1]);

console.log('-----------------------------');
//8. is there any product can be purchased by Rs. 10
a=products.some(item=>item[2]<=10)
